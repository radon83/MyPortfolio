                ...
                <div class="container">
                    <div class="row align-items-center row--30">
                        ...
                        <div class="col-lg-7 mt_md--40 mt_sm--40">
                            <div class="content">
                                <div class="inner">
                                    <h1 class="title">Hi, I’m <span>Rodainah Ayman</span><br> a
                                    ...
                                    <div>
                                        <p class="description">Arab Open University Graduate. Specialized in the field of Information Technology and Computing.
                                            <br><br>
                                            Aspire to be a part of an organization that will provide me with the opportunity to excel 
                                            professionally and enhance my potential and skills by working with commitment and 
                                            excellence in a progressive environment.</p>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12 mt_mobile--30">
                                        <div class="skill-share-inner">
                                            ...
                                            <ul class="skill-share d-flex liststyle">
                                                <li><img src="assets/images/icons/icons-20.png" alt="Icons Images" style="max-height: 44px;"></li>
                                                <li><img src="assets/images/icons/icons-22.png" alt="Icons Images"></li>
                                                <li><img src="assets/images/icons/icons-23.png" alt="Icons Images"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Web App Development Services</a></h4>
                                    <p class="description">Build a secure and custom product that delivers a great experience and aligns with your goals.</p>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Web API Services</a></h4>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">eCommerce Websites</a></h4>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Project Management Services</a></h4>
                                    <p class="description">Ensure the implementation of your project strategy is efficient and effective throughout the stages of software development.
                                    </p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Website Redesign Services</a></h4>
                                    <p class="description">
                                        Give your existing website a brand new look aligned with modern design practices.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-sm-12 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Personal Portfolio</a></h4>
                                    <p class="description">Portfolio is a personal web page. Which can represent works you have created, as well as your skills and experiences.</p>
                                    <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                ...
                <div class="row mt--45">
                    <div class="col-lg-12">
                        <ul class="rn-nav-list nav nav-tabs" id="myTabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="experience-tab" data-bs-toggle="tab" href="#experience" role="tab" aria-controls="experience" aria-selected="false">Work experience</a>
                            </li>
                                ...
                                <div class="personal-experience-inner mt--40">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <div class="content">
                                                <span class="subtitle">20011 - 2020</span>
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            ...
                                                            <p class="description">Bachelor of Science: Information Technology and Computing</p>
                                                        </div>
                                                    </div>
                                                    <!-- End Single List  -->
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12 mt_md--60 mt_sm--60">
                                            <div class="content">
                                                ...
                                                <h4 class="maintitle">Self Education</h4>
                                                <div class="experience-list">
                                                ...
                                                <div class="resume-single-list">
                                                    <div class="inner">
                                                        <div class="heading">
                                                            <div class="title">
                                                                <h4>Network Security foundation</h4>
                                                                <span> 2021 </span>
                                                            </div>
                                                            
                                                        </div>
                                                        <p class="description"> Learned some of the basics of network security and security
                                                            terminology which is widely used in the field in addition
                                                            to clarifying some important concepts in the field of information security and cybersecurity.
                                                            </p>
                                                    </div>
                                                </div>
                                                <!-- End Single List  -->
                                                ...
                                                <div class="resume-single-list">
                                                    <div class="inner">
                                                        <div class="heading">
                                                            <div class="title">
                                                                <h4>Laravel framework course </h4>
                                                                <span> 2021 </span>
                                                            </div>
                                                            
                                                        </div>
                                                        <p class="description">Work with Laravel framework and build some projects 
                                                        </p>
                                                    </div>
                                                </div>
                                                <!-- End Single List  -->
                                                ...
                                                <div class="resume-single-list">
                                                    <div class="inner">
                                                        <div class="heading">
                                                            <div class="title">
                                                                <h4>Analyzing Data with Microsoft Power BI</h4>
                                                                <span> 2022 </span>
                                                            </div>
                                                            
                                                        </div>
                                                        <p class="description">Power BI is a robust business analytics and visualization tool from Microsoft that helps data professionals bring their data to life
                                                            </p>
                                                    </div>
                                                </div>
                                                <!-- End Single List  -->
                                            ...
                                            <div class="progress-wrapper">
                                                <div class="content">
                                                    ...
                                                    <div class="progress-charts">
                                                        <h6 class="heading heading-h6">Power bi</h6>
                                                        <div class="progress">
                                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay=".3s" role="progressbar" style="width: 50%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>Keep knowledge</h4>
                                                                    <span>2020</span>
                                                                </div>
                                                         
                                                            </div>
                                                            <p class="description">A website for Arab Open University library which keep track on every loan process and manage all the resources.</p>
                                                        </div>
                                                    </div>
                                                    <!-- End Single List  -->
                    ...
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            ...
                            <div class="title-area">
                                <h4 class="title">Rodainah Ayman</h4>
                                <span>Freelancer Programmer</span>
                            </div>
                            <div class="description">
                                <p>I am available for freelance work. Connect with me via and call in to my account.
                                </p>
                                <span class="phone">Phone: <a href="tel:00966545196602">+966545196602</a></span>
                                <span class="mail">Email: <a href="mailto:rodainahab@gmail.com">Rodainahab@gmail.com</a></span>
                            </div>
...
<!-- Mirrored from rainbowit.net/html/inbio/home-content-writer-white-version.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 May 2022 10:17:38 GMT -->
</html>